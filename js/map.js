...
export const localMaps = {
    ...
    '청성산': {
        ...
        spots: {
            ...
            '숲속': { x: 0, y: 3, icon: '🌲', tile: 'forest' },
            '산길': { x: 2, y: 4, icon: '🛤️', tile: 'mountain' },
        },
        connections: {
            '청성산': ['도관', '숲속', '산길'],
            '도관': ['청성산', '숲속'],
    ...
    '아미금정': {
        ...
        spots: {
            ...
            '산채길': { x: 0, y: 2, icon: '⛰️', tile: 'mountain' },
...
export const murimLore = {
    ...
    '약초원': { faction: '중립', danger: '중', desc: '촌 뒤 숲속 약초밭. 산적이 숨어들기 쉬운 곳.', rumor: '숲적두가 약초를 거두며 통행세를 거둔다 한다.' },
    '숲길': { faction: '중립', danger: '중', desc: '촉남촌과 약초원을 잇는 숲길.', rumor: '낮에도 도적이 출몰한다.' },
    '숲속': { faction: '중립', danger: '중', desc: '청성산 아래 울창한 숲.', rumor: '산채호법이 숲속에 거처한다는 소문.' },
    '산길': { faction: '중립', danger: '상', desc: '청성산을 오르는 험한 산길.', rumor: '산적 무리가 산길을 지킨다.' },
    '산채길': { faction: '중립', danger: '중', desc: '아미금정 아래 산채로 이어지는 길.', rumor: '산적이 산채길에서 기습한다.' },
    '산적소굴': { faction: '사파', danger: '상', desc: '검각관 근처 산적 소굴.', rumor: '검각 산적두목이 우두머리라 한다.' },
